...
//                 </h5>
//                 <p>${description}</p>
//                 <a href="${link}" class="btn mt-auto"><i class="fab fa-github mr-2">L</i>View Project on Github</a>
//             </div>
//         `;
//     });
...
// //         <link rel="stylsheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11/css/all.min.css">
...
// //                 <nav class="flex-row">
// //                     <a class="ml-2 my-1 px-1 bg-secondary text-dark" href="https://github.com/${header.github
// //         }">Github</a>"
// //                 </nav>
// //             </header>
